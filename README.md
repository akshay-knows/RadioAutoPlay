...
Current app version: **v1.19**

Download the latest APK from [GitHub Releases](https://github.com/akshay-knows/RadioAutoPlay/releases/latest).

The v1.19 APK is also archived here after the release workflow finishes:

```text
apk-releases/v1.19/RadioAutoPlay-v1.19.apk
```
...
```bash
git tag -a v1.19 -m "Radio AutoPlay v1.19"
