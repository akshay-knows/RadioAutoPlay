...
Current app version: **v1.11**

Download the latest APK from [GitHub Releases](https://github.com/akshay-knows/RadioAutoPlay/releases/latest).

The v1.11 APK is also archived here after the release workflow finishes:

```text
apk-releases/v1.11/RadioAutoPlay-v1.11.apk
```
...
```bash
git tag -a v1.11 -m "Radio AutoPlay v1.11"
