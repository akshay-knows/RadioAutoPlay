...
Current app version: **v1.18**

Download the latest APK from [GitHub Releases](https://github.com/akshay-knows/RadioAutoPlay/releases/latest).

The v1.18 APK is also archived here after the release workflow finishes:

```text
apk-releases/v1.18/RadioAutoPlay-v1.18.apk
```
...
```bash
git tag -a v1.18 -m "Radio AutoPlay v1.18"
